...
const careerPaths = [
  ...
  "I connect threat detection, risk review, and documentation into stronger security decisions.",
  "I bring calm, structure, and technical curiosity to complex security problems.",
];
